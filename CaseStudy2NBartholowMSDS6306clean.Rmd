...
ce <- ddply(DFTrainRel, "JobRole", transform,
...
```{rVariable Iterations}
#Composite Happiness Scores
DFTrainFS <- cbind.data.frame(DFTrainRel$ID, DFTrainRel$Attrition, DFTrainRel$BusinessTravel, DFTrainRel$Department, DFTrainRel$Education, DFTrainRel$EducationField, DFTrainRel$EnvironmentSatisfaction, DFTrainRel$Gender, DFTrainRel$HourlyRate, DFTrainRel$JobInvolvement, DFTrainRel$JobLevel, DFTrainRel$JobRole, DFTrainRel$JobSatisfaction, DFTrainRel$MaritalStatus, DFTrainRel$MonthlyRate, DFTrainRel$NumCompaniesWorked, DFTrainRel$OverTime, DFTrainRel$PercentSalaryHike, DFTrainRel$PerformanceRating, DFTrainRel$RelationshipSatisfaction, DFTrainRel$StockOptionLevel, DFTrainRel$TotalWorkingYears, DFTrainRel$TrainingTimesLastYear, DFTrainRel$WorkLifeBalance, DFTrainRel$YearsAtCompany, DFTrainRel$YearsSinceLastPromotion, DFTrainRel$YearsWithCurrManager, DFTrainRel$YearsInCurrentRole )
DFValFS <- cbind.data.frame(DFValRel$ID, DFValRel$Attrition, DFValRel$BusinessTravel, DFValRel$Department, DFValRel$Education, DFValRel$EducationField, DFValRel$EnvironmentSatisfaction, DFValRel$Gender, DFValRel$HourlyRate, DFValRel$JobInvolvement, DFValRel$JobLevel, DFValRel$JobRole, DFValRel$JobSatisfaction, DFValRel$MaritalStatus, DFValRel$MonthlyRate, DFValRel$NumCompaniesWorked, DFValRel$OverTime, DFValRel$PercentSalaryHike, DFValRel$PerformanceRating, DFValRel$RelationshipSatisfaction, DFValRel$StockOptionLevel, DFValRel$TotalWorkingYears, DFValRel$TrainingTimesLastYear, DFValRel$WorkLifeBalance, DFValRel$YearsAtCompany, DFValRel$YearsSinceLastPromotion, DFValRel$YearsWithCurrManager, DFValRel$YearsInCurrentRole )

#Create Composite Happiness withOUT Job Involvement
DFTrainFS$HappinessNoJI <- NULL
DFTrainFS$HappinessNoJI <- DFTrainRel$EnvironmentSatisfaction+DFTrainRel$JobSatisfaction+DFTrainRel$RelationshipSatisfaction+DFTrainRel$WorkLifeBalance #train
DFValFS$HappinessNoJI <- NULL
DFValFS$HappinessNoJI <- DFValRel$EnvironmentSatisfaction+DFValRel$JobSatisfaction+DFValRel$RelationshipSatisfaction+DFValRel$WorkLifeBalance #test

#Create Composite Happiness WITH Job Involvement
DFTrainFS$HappinessWJI <- DFTrainFS$HappinessNoJI+DFTrainRel$JobInvolvement #train
DFValFS$HappinessWJI <- DFValFS$HappinessNoJI+DFValRel$JobInvolvement #test

#Create Composite Years
DFTrainFS$YearsComposite <- NULL
DFTrainFS$YearsComposite <- (DFTrainRel$YearsAtCompany+DFTrainRel$YearsSinceLastPromotion+DFTrainRel$YearsWithCurrManager+DFTrainRel$YearsInCurrentRole)/4

DFValFS$YearsComposite <- NULL
DFValFS$YearsComposite <- (DFValRel$YearsAtCompany+DFValRel$YearsSinceLastPromotion+DFValRel$YearsWithCurrManager+DFValRel$YearsInCurrentRole)/4

#ggpairs(DFTrainFS[c(5,7,8,9,10,12,13,14,15,16,19,20,22:24)])
...
DFAttrY <- DFTrainFRel[grep("Yes", DFTrainFRel$Attrtion), ]
...
#Create Composite Happiness withOUT Job Involvement
training_data$HappinessNoJI <- NULL
training_data$HappinessNoJI <- training_data$EnvironmentSatisfaction+training_data$JobSatisfaction+training_data$RelationshipSatisfaction+training_data$WorkLifeBalance #train
test_data$HappinessNoJI <- NULL
test_data$HappinessNoJI <- test_data$EnvironmentSatisfaction+test_data$JobSatisfaction+test_data$RelationshipSatisfaction+test_data$WorkLifeBalance #test

#Create Composite Happiness WITH Job Involvement
training_data$HappinessWJI <- training_data$HappinessNoJI+training_data$JobInvolvement #train
test_data$HappinessWJI <- test_data$HappinessNoJI+test_data$JobInvolvement #test


#Create Composite Years
training_data$YearsComposite <- NULL
training_data$YearsComposite <- DFTrainFS$YearsComposite
  
  #(training_data$YearsAtCompany+training_data$YearsSinceLastPromotion+training_data$YearsWithCurrManager+training_data$YearsInCurrentRole)/4

test_data$YearsComposite <- NULL
test_data$YearsComposite <- DFValFS$YearsComposite
  #(test_data$YearsAtCompany+test_data$YearsSinceLastPromotion+test_data$YearsWithCurrManager+test_data$YearsInCurrentRole)/4
...
```{rCreate Composite for TrainRel}
#Create Composite Happiness withOUT Job Involvement
DFTrainRel$HappinessNoJI <- NULL
DFTrainRel$HappinessNoJI <- DFTrainRel$EnvironmentSatisfaction+DFTrainRel$JobSatisfaction+DFTrainRel$RelationshipSatisfaction+DFTrainRel$WorkLifeBalance #train
DFValRel$HappinessNoJI <- NULL
DFValRel$HappinessNoJI <- DFValRel$EnvironmentSatisfaction+DFValRel$JobSatisfaction+DFValRel$RelationshipSatisfaction+DFValRel$WorkLifeBalance #test

#Create Composite Happiness WITH Job Involvement
DFTrainRel$HappinessWJI <- DFTrainRel$HappinessNoJI+DFTrainRel$JobInvolvement #train
DFValRel$HappinessWJI <- DFValRel$HappinessNoJI+DFValRel$JobInvolvement #test

#Create Composite Years
DFTrainRel$YearsComposite <- NULL
DFTrainRel$YearsComposite <- (DFTrainRel$YearsAtCompany+DFTrainRel$YearsSinceLastPromotion+DFTrainRel$YearsWithCurrManager+DFTrainRel$YearsInCurrentRole)/4

DFValRel$YearsComposite <- NULL
DFValRel$YearsComposite <- (DFValRel$YearsAtCompany+DFValRel$YearsSinceLastPromotion+DFValRel$YearsWithCurrManager+DFValRel$YearsInCurrentRole)/4
