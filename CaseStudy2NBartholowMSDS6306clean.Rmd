...
CS2DataRelevant <- CS2DataRelevant[,-22] #remove Over18
CS2DataRelevant <- CS2DataRelevant[,-26] #remove StandardHours
CS2DataRelevant <- CS2DataRelevant[,-1] #remove ID
CS2DataRelevant <- CS2DataRelevant[,-33] #remove Rand
...
CS2ValRel <- CS2ValRel[,-1] #remove ID
CS2ValRel <- CS2ValRel[,-33] #remove Rand
...
ggplot(data = CS2Data, mapping = aes(x = Attrition, y = JobSatisfaction)) +
  geom_boxplot() #JobSatid=sfaction of 1
...
#results <- class::knn(CS2DataRelevant[, c(10, 20, 33)], CS2Val[,c(12, 22, 38)], CS2DataRelevant$Att, k=3)
#Overall Accuracy 0.8267
results3 <- class::knn(CS2DataRelevant[,c(10, 20, 33)], CS2ValRel[,c(10, 20, 33)], CS2DataRelevant$Att, k=3)
CS2ValRel$AttPred3 <- results3
confusionMatrix(table(CS2ValRel$Attrition,CS2ValRel$AttPred3))
