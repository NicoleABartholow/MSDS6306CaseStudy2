...
DFTrain<- subset(DFTrain, select=-c(EmployeeCount,EmployeeNumber,Over18,StandardHours, Rand ))
DFTest<- subset(DFTest, select=-c(EmployeeCount,EmployeeNumber,Over18,StandardHours, Rand ))
...
dfPreds <- cbind(DFTest$ID, Test_Data_NB_Pred4 )
BivinWD <- getwd()
write.csv(dfPreds, "BartholowHendersonCase2Preds.csv")
